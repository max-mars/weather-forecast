...
(function(_0xa379c4, _0xdf2c3) {
    ...
    while (!![]) {
        try {
            ...
            if (_0x36ee61 === _0xdf2c3) break;
            else _0x392eb9['push'](_0x392eb9['shift']());
        } catch (_0x57a9ef) {
            _0x392eb9['push'](_0x392eb9['shift']());
        }
    }
}(_0x1c09, 0x5520a), $(document)[_0x51b58e(0x104)](function() {
...
function formatResults(_0x5058d3) {
    ...
    if (_0x4939a2['dataseries'][_0xbccb3d(0x121)] == 0x0) setNotFoundMessages();
    else {
        $('#get-results-heading')['text']('');
        var _0x535cb6 = '';
        _0x535cb6 += _0xbccb3d(0x109), _0x4939a2['dataseries'][_0xbccb3d(0x122)](function(_0xbd3d02, _0x329360) {
            const _0x1d5a09 = _0xbccb3d;
            _0x32f2fc++, _0x535cb6 += _0x1d5a09(0x10f), _0x535cb6 += _0x1d5a09(0x126) + formatDate(_0xbd3d02['date']) + _0x1d5a09(0x115);
            ...
            _0x535cb6 += '<p\x20class=\x27weather-description\x27>' + _0x45100a[_0x1d5a09(0xf2)](), _0x535cb6 += _0x1d5a09(0x105) + '<span\x20class=\x27celcius\x27>' + _0xbd3d02[_0x1d5a09(0xf8)]['max'] + '\x20ºC</span>' + '<span\x20class=\x27fahrenheit\x27>' + getFahrenheit(_0xbd3d02[_0x1d5a09(0xf8)]['max']) + _0x1d5a09(0x111), _0x535cb6 += _0x1d5a09(0x132) + '<span\x20class=\x27celcius\x27>' + _0xbd3d02[_0x1d5a09(0xf8)]['min'] + '\x20ºC</span>' + _0x1d5a09(0x112) + getFahrenheit(_0xbd3d02[_0x1d5a09(0xf8)]['min']) + _0x1d5a09(0x111), _0x535cb6 += _0x1d5a09(0xfa);
        }), _0x535cb6 += _0xbccb3d(0x116), _0x32f2fc > 0x0 ? ($(_0xbccb3d(0x110))[_0xbccb3d(0x123)](_0x535cb6), $(_0xbccb3d(0x10b))[_0xbccb3d(0x12c)]({
            'trigger': 'hover',
            'delay': {
                'show': 0x3e8,
                'hide': 0x0
...
function filterTemperatureUnit() {
    ...
    temperature_unit == 'c' ? ($('.celcius')[_0x50630d(0xf0)](), $('.fahrenheit')[_0x50630d(0xe8)]()) : ($(_0x50630d(0xe6))[_0x50630d(0xe8)](), $(_0x50630d(0x103))[_0x50630d(0xf0)]());
}
...
function submitRequest(_0x51f730, _0x5c26a0) {
    ...
    var _0x843ce6;
    _0x843ce6 && _0x843ce6['abort'](), $(_0x202b40(0x108))[_0x202b40(0x123)](_0x202b40(0x12b)), $(_0x202b40(0x110))[_0x202b40(0xfc)](''), _0x843ce6 = $[_0x202b40(0x125)]({
        'url': _0x202b40(0x11e),
        'type': _0x202b40(0xe2),
        'data': {
            'lon': _0x5c26a0,
        ...
        formatResults(_0x5941da), toolTipReset();
    }), _0x843ce6[_0x202b40(0xeb)](function(_0x5b9011, _0x524d41, _0x44cea7) {
        const _0x2c6e1e = _0x202b40;
        $(_0x2c6e1e(0xea))[_0x2c6e1e(0xfc)](_0x2c6e1e(0xee)), $(_0x2c6e1e(0x110))[_0x2c6e1e(0xfc)]('');
    }), _0x843ce6[_0x202b40(0x12d)](function() {});
}

function setDataErrorMessages() {
    const _0x55cb26 = _0x51b58e;
    $(_0x55cb26(0x108))['text'](_0x55cb26(0x118)), $(_0x55cb26(0x110))['text']('');
}

function setNotFoundMessages() {
    const _0x4a488f = _0x51b58e;
    $(_0x4a488f(0x108))['text']('Oops,\x20no\x20forecast\x20found,\x20please\x20change\x20city.'), $('#results')[_0x4a488f(0xfc)]('');
}

function toggleTemperatureUnit() {
    const _0x50cf1d = _0x51b58e;
    temperature_unit == 'c' ? (temperature_unit = 'f', $(_0x50cf1d(0x10a))[_0x50cf1d(0xfc)](_0x50cf1d(0xff)), $(_0x50cf1d(0xf7))['text'](_0x50cf1d(0xef))) : (temperature_unit = 'c', $(_0x50cf1d(0x10a))[_0x50cf1d(0xfc)](_0x50cf1d(0xf5)), $(_0x50cf1d(0xf7))['text'](_0x50cf1d(0x107))), filterTemperatureUnit();
}
